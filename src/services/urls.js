...
export const admin = "https://admin.righttime.fun";

export const dummy_aviator = "https://right-time-timer.onrender.com";
export const domain = "https://right-time-timer.onrender.com";
...
export const newdomain = "https://api.righttime.fun";
export const endpoint = {
  ...
  attendence_income: `${newdomain}/api/v1/attendance-bonus`,
  claim_income: `${newdomain}/api/v1/clame-bonus`,
  invitation_income: `${newdomain}/api/v1/inivitation-bonus`,
  streak_income: `${newdomain}/api/v1/winning-streak-bonus`,
  ...
  get_yesterday_deposit_withdrawl_by_treamFn: `${newdomain}/api/v1/get_yesterday_deposit_withdrawl_by_treamFn`,
  top11winner: `${newdomain}/api/v1/get-top-winners`,
  ...
  cashback_report: `${newdomain}/api/v1/getCashBack-report`,

  //payment
  withdraw_payment: `${newdomain}/api/v1/inr-payout-request`,
  payment_request: `${newdomain}/api/v1/inr-payin-request`,
  deposit_history_usdt: `${newdomain}/api/v1/deposit-history-usdt`,
  withdrawal_request_usdt: `${newdomain}/api/v1/payout-request`,
  withdrawal_address_usdt: `${newdomain}/api/v1/add-usdt-address`,
  get_address_list: `${newdomain}/api/v1/usdt-address-record`,
  withdrawl_usdt_history: `${newdomain}/api/v1/withdrawal-history-usdt`,
...
//income
  welcome_bonus: `${newdomain}/api/v1/welcome-bonus`,
  self_deposite_bonus: `${newdomain}/api/v1/self-deposit-bonus`,
  deposit_bonus: `${newdomain}/api/v1/get-deposit-bonus-income`,
  team_trading_bonus :`${newdomain}/api/v1/get-self-trading-bonus`,
  level_bonus: `${newdomain}/api/v1/level-income`,
  roi_bonus: `${newdomain}/api/v1/get-roi-bonus`,

  daily_salary_income: `${newdomain}/api/v1/daily-salary-icome`,
  weekly_salary_income: `${newdomain}/api/v1/weekly-salary-icome`,
  ...
  //income
  subordinate_data: `${newdomain}/api/v1/get-subordinate-data-funx`,
  commission_data: `${newdomain}/api/v1/get-commisssion-data-funx`,
  tranfer_wallet: `${newdomain}/api/v1/transfer-amount-from-working-wallet-to-main-wallet`,
  transfer_wallet_history: `${newdomain}/api/v1/transfer-history-from-working-wallet-to-main-wallet`,
  yesterday_income: `${newdomain}/api/v1/get-total-betA-ad-income-yesterday`,
  status_popup: `${newdomain}/api/v1/hideStatusOfDepositPopup`,
  get_level_general: `${newdomain}/api/v1/get_level_general_data`,
  get_claim_card: `${newdomain}/api/v1/claim-gift-card`,
  get_gift: `${newdomain}/api/v1/get-gift-card-list`,
  incom_gift : `${newdomain}/api/v1/gift-bonus-list`,
  level_income : `${newdomain}/api/v1/level-income`,
