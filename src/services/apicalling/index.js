...
import { apiConnectorGet, apiConnectorPost } from "../apiconnector";
...
export const GetTopFn = async () => {
  try {
    const response = await apiConnectorGet(endpoint.node_api.get_top_users);
    return response;
  } catch (e) {
    toast(e?.message);
    console.log(e);
...
export const MyProfileDataFn = async (navigate) => {
  try {
    const response = await apiConnectorGet(`${endpoint.profiledata}?user_id=${user_id}`,{},navigate);
    return response;
  } catch (e) {
    toast(e?.message);
    console.log(e);
...
export const CandidateNameFn = async (reqbody) => {
  try {
    const response = await apiConnectorGet(`${endpoint.get_name_by_referral_code}`, {
      params: reqbody
    });
...
export const cashDepositFn = async (reqbody) => {
  try {
    const res = apiConnectorGet(`${endpoint.cash_deposit}`, {
      params: reqbody
    });
    if (res) {
...
export const getAllBetsAviator = async () => {
  try {
    const response = await apiConnectorGet(`${endpoint.total_bet_history}`);
    return response;
  } catch (e) {
    toast(e?.message);
    console.log(e);
...
export const walletamount = async (navigate) => {
  try {
    const response = await apiConnectorGet(
...
export const allWithdrawlCashUserFn = async () => {
  try {
    const response = await apiConnectorGet(`${endpoint.all_withdrawl_user_list}`);
    return response;
  } catch (e) {
    toast(e?.message);
    console.log(e);
...
export const top11WinnerFunction = async () => {
  try {
    const response = await apiConnectorGet(`${endpoint.top11winner}`);
    return response;
  } catch (e) {
    toast(e?.message);
    console.log(e);
...
export const yesterdayFn = async (navigate) => {
  try {
    const response = await apiConnectorGet(
...
export const WelcomeIncomeFn = async () => {
  try {
    const response = await apiConnectorGet(
      `${endpoint.welcome_bonus}?user_id=${user_id}`
    );
    return response;
  } catch (e) {
    toast(e?.message);
